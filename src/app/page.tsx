...
const Page = async () => {
  ...
  return (
    <div className="h-auto overflow-x-hidden">
      <section className="grid place-items-center h-screen bg-gradient-to-t from-[#2e243c]">
        <div className="flex flex-col justify-center">
          <div className="font-extrabold m-auto mb-6">
            <SparklesText text={`Hi ${user ? user.firstName : "There"}`} />
          </div>

          <MarqueeDemo />

          <CoolMode>
            <Button className="w-fit m-auto mt-5">Subscribe</Button>
          </CoolMode>
        </div>
      </section>
      ...
      <section className="grid place-items-center h-screen w-screen">
        <MagicContainer
          className={
            "flex h-[500px] w-fit flex-col gap-4 lg:h-[250px] lg:flex-row"
          }>
